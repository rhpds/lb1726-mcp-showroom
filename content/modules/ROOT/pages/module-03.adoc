...
. In Gitea navigate to `{user}/mcp/tenant/mcp-openshift/templates` and create a new file `mcptoolconfig.yaml`:
+
...
. In Gitea, navigate to `{user}/mcp/tenant/mcp-gitea`.
...
. In Gitea, navigate to `{user}/mcp/tenant/mcp-gitea/templates`.
