...
. Switch to the *Topology* view and click on the agent pod.
. Click on *View logs* to show the pod logs - where you can show that the agent started up, connected to a LLM and connected to two MCP Agents - OpenShift and Gitea.
...
. Switch to *Topologys* and open the *agent-xxxxx* pod (your specific pod name will be different).
