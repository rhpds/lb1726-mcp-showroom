  ...
  registry.json: |
    {
      ...
      "servers": {
        "kubernetes-mcp-server": {
          ...
          "image": "quay.io/containers/kubernetes_mcp_server:v0.0.56",
          "permissions": {
            "network": {
              "outbound": {}
            }
...
[start=3]
. Create a secret with the User ID and Password for the PostgreSQL database (in the real world you would store that secret somewhere else and not in the repository).
